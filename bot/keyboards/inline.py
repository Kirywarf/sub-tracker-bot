...
def get_subscription_card_keyboard(
    ...
    buttons.append([
        ...
        InlineKeyboardButton(text="‹ К списку", callback_data="list_subs"),
    ])
    return InlineKeyboardMarkup(inline_keyboard=buttons)
...
def get_delete_confirm_keyboard(sub_id: int) -> InlineKeyboardMarkup:
    buttons = [
        [
            InlineKeyboardButton(text="✕ Да, удалить", callback_data=f"confirm_del_{sub_id}"),
...
def get_edit_fields_keyboard(sub_id: int) -> InlineKeyboardMarkup:
    buttons = [
        ...
        [
            InlineKeyboardButton(text="‹ Назад к карточке", callback_data=f"view_sub_{sub_id}"),
        ],
    ]
    return InlineKeyboardMarkup(inline_keyboard=buttons)
